...
pGroup("EI"). % Explicit
pGroup("QID"). % Quasi-Identifier
pGroup("SD"). % Sensitive
pGroup("NSD"). % Non-Sensitive
...
entityType("DataProtectionOfficer").
...
dataCategory(dc_derived,("derived personal data",[("en","Derived Personal Data")],[("en","Derived data is data that is obtained or derived from other data.")])).
% internal
dataCategory(dc_knowledge,("knowledge and belief",[("en","Knowledge and Belief")],[("en","Information about what a person knows or believes, e.g., religious beliefs, philosophical beliefs, thoughts, what they know and don't know, what someone thinks")])).
...
dataCategory(dc_preference,("preference",[("en","Preference")],[("en","Information about an individual's preferences or interests, e.g., opinions, intentions, interests, favorite foods, colors, likes, dislikes, music")])).
% external
...
dataCategory(dc_behavioral,("behavioral",[("en","Behavioral")],[("en","Information that describes an individual's behavior or activity, e.g., browsing behavior, call logs, links clicked, demeanor, attitude")])).
dataCategory(dc_demographic,("demographic",[("en","Demographic")],[("en","Information that describes an individual's characteristics shared with others, e.g., age ranges, physical traits, income brackets, geographic")])).
dataCategory(dc_physical,("physical characteristics",[("en","Physical Characteristics")],[("en","Information that describes an individual's physical characteristics, e.g., height, weight, age, hair color, skin tone, tattoos, gender, piercings")])).
% tracking
...
% historical
dataCategory(dc_historical,("historical",[("en","Historical")],[("en","Information about an individual's personal history, e.g., events that happened in a person's life, either to them or just around them which might have influenced them (WWII,9/11)")])).
% financial
...
dataCategory(dc_transactional,("transactional",[("en","Transactional")],[("en","Information about an individual's purchasing, spending, or income, e.g., purchases, sales, credit, income, loan records, transactions, taxes, purchases and spending habits")])).
dataCategory(dc_credit,("credit",[("en","Credit")],[("en","Information about an individual's reputation with regards to money, e.g., credit records, credit worthiness, credit standing, credit capacity")])).
% social
...
dataCategory(dc_sexual,("sexual",[("en","Sexual")],[("en","Information that describes an individual's sexual life, e.g., gender identity, preferences, proclivities, fetishes, history, etc.")])). % external
