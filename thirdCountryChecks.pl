thirdCountryDR(N,TCT,_,_,S,P) :- % 01. optional: no third country transfer, safeguards have been supplied, but not necessary, all correct, just a hint
    \+ TCT,
    []\=S,
...
thirdCountryDR(N,TCT,CO,_,_,P) :- % 04. no third country transfer, country provided, wrong (HINT)
    \+ TCT,
    CO\="",
...
thirdCountryDR(N,TCT,CO,_,S,P) :- % 09. optional: third country transfer to adequate country, actually (marked as adequate), safeguards have been supplied, but not necessary, all correct, just a hint
    TCT,
    adequate(CO),
...
thirdCountryDR(N,TCT,CO,AD,S,P) :- % new: third country transfer to non adequate wildcard (*) country, not marked as adequate, safeguards have been specified, hint for missing country
    TCT,
    \+ adequate(CO),
    country(CO),
    CO == "*",
